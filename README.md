...
`ANTHROPIC_API_KEY`, `SUPABASE_SERVICE_ROLE_KEY`, `MERCADO_PAGO_ACCESS_TOKEN` e `MERCADO_PAGO_WEBHOOK_SECRET` ficam apenas no servidor. `NEXT_PUBLIC_MERCADO_PAGO_PUBLIC_KEY` é pública e pode ser usada no frontend.
